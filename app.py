...
if page == "Overview & Expanded Report":
    ...
    **2026 Highlights:**
    ...
    st.image("https://via.placeholder.com/700x300/006400/FFFFFF?text=False-Color+Composite+(Alteration+Zones)", caption="False-Color Composite")
    st.image("https://via.placeholder.com/700x300/FF4500/FFFFFF?text=Li-Clay+Probability+Heatmap", caption="Mineral Probability Heatmap")
    if st.button("Simulate Live HSI Upload"):
        st.success("✅ HSI processed! (In full version this would update map + report with new mineral layers)")
...
st.sidebar.success("✅ Demo features loaded — Claims, Land Intel, HSI, Dashboard, Chat, PDF Export")
